...
export const users = pgTable("users", {
  ...
  activityPattern: jsonb("activity_pattern").default({}),
  personalityTraits: jsonb("personality_traits").default({}),
  compatibilityFactors: jsonb("compatibility_factors").default({}),
  matchPreferences: jsonb("match_preferences").default({}),
